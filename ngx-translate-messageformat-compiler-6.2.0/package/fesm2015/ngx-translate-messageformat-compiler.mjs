...
class TranslateMessageFormatCompiler extends TranslateCompiler {
    constructor(config) {
        ...
        const { formatters: customFormatters, biDiSupport, strictNumberSign: strict, currency, } = Object.assign(Object.assign({}, defaultConfig), config);
    ...
    compileTranslations(translations, lang) {
        ...
        return Object.keys(translations).reduce((acc, key) => {
            ...
            return Object.assign(Object.assign({}, acc), { [key]: this.compileTranslations(value, lang) });
        }, {});
    }
